...
from core.trajectory.paths import path_static_sinusoid 
from robots.rconfig import FL_chain, BODY_HEIGHT, get_q_nominal
...
class StaticLegController:
    ...
    def step(self, dt_s: float) -> np.ndarray:
        ...
        p_des = path_static_sinusoid(s, self.p0, self.config.amplitude_m, self.config.lift_height_m)
